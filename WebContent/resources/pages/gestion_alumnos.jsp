								...
								<fieldset>
									...
									<div class="form-group">
										<label for="fecha">Fecha de nacimiento</label> <input
											type="text" id="fecha" name="fecha" class="form-control"
									...
									<div class="form-group">
										<label for="estado_civil">Estado civil</label> <select
											id="estado_civil" name="estado_civil" class="form-control"
											data-bv-notempty="true"
									...
									<div class="radio">
										<label> <input type="radio" name="genero"
											id="masculino" name="masculino" value="masculino"
											data-bv-notempty="true"
									...
									<div class="radio">
										<label> <input type="radio" name="genero"
											id="femenino" name="femenino" value="femenino">
											Femenino
										</label>
									</div>
								</fieldset>
								<fieldset>
									...
									<div class="form-group">
										<label for="num_ext">Numero Exterior</label> <input
											type="number" id="num_ext" name="num_ext"
									...
									<div class="form-group">
										<label for="num_int">Numero Interior</label> <input
											type="number" id="num_int" name="num_int"
							...
							<div class="col-md-6">
								<div class="form-group">
									<label for="num_depto">Numero de departamento</label> <input
										type="number" id="num_depto" name="num_depto"
